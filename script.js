...
var buscarEndereco = function () { return __awaiter(_this, void 0, void 0, function () {
    var cep, resposta, dados, erro_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                if (divResultado) {
                    divResultado.innerHTML = "<p><strong>Logradouro:</strong>".concat(dados.Logradouro, "</p>\n      <p><strong>Bairro:</strong> ").concat(dados.bairro, "</p>\n      <p><strong>Cidade:</strong> ").concat(dados.localidade, " - ").concat(dados.uf, "</p>");
                }
                return [3 /*break*/, 5];
            case 4:
                erro_1 = _a.sent();
                console.error("Erro na busca:", erro_1);
                if (divResultado)
